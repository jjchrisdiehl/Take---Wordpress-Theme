...
//	wp_enqueue_style( 'bootstrap_css', get_stylesheet_uri() );
	...
	//wp_enqueue_script( 'psd2wp-navigation', get_template_directory_uri() . '/dist/build/production.min.js', array(), true );
	...
	wp_enqueue_script( 'production', get_template_directory_uri() . '/dist/build/production.min.js', array(), true );

	wp_enqueue_script( 'theme', get_template_directory_uri() . '/dist/js/theme.js', array(), true );
